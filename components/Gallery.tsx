...
const Gallery: React.FC<GalleryProps> = ({ projects, onProjectClick }) => {
  ...
  return (
    <section className="min-h-screen pt-48 pb-12 md:pt-72 md:pb-20 bg-[#050505]">
            ...
            >
              ...
              <div className="aspect-[4/5] md:aspect-[4/3] overflow-hidden relative z-0">
                ...
                <div className="absolute bottom-0 left-0 w-full p-6 md:p-8 z-10">
                   <h3 className="font-logo text-3xl md:text-4xl text-white group-hover:text-bocha-pink transition-colors drop-shadow-md uppercase tracking-normal leading-tight">
