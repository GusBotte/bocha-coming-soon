  ...
  return (
    <section id="contact" className="py-24 px-4 w-full flex flex-col items-center justify-center bg-black relative overflow-hidden">
      ...
      <div className="text-center mb-12 z-10">
        <h2 className="text-5xl md:text-7xl font-sans font-black text-white tracking-normal leading-none uppercase mb-2">
          LET'S PROMPT
        </h2>
        <h2 className="text-5xl md:text-7xl font-sans font-black text-bocha-pink tracking-normal leading-none uppercase">
          WHAT'S NEXT
        </h2>
      </div>
