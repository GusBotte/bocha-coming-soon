...
const Workflow: React.FC<WorkflowProps> = ({ items, onItemClick }) => {
  ...
  return (
    <section className="min-h-screen pt-48 pb-16 md:pt-32 md:pb-20 px-4 md:px-6 bg-[#050505] relative overflow-hidden">
      ...
      <div className="w-full max-w-5xl mx-auto relative z-10">
        <div className="text-center mb-12 md:mb-24 animate-fade-in">
          ...
          <p className="text-gray-400 mt-4 md:mt-6 max-w-2xl mx-auto text-sm md:text-base px-4">
            {language === 'en' 
              ? 'Transparency in every pixel. Discover the tools and methods that power our creative engine.'
              : 'Transparencia en cada píxel. Descubrí las herramientas y métodos que potencian nuestro motor creativo.'}
          </p>
        </div>
