...
const About: React.FC = () => {
  ...
  return (
    <section className="min-h-screen bg-bocha-black text-white pt-32 pb-20 px-4 md:px-6 flex flex-col items-center">
      ...
      >
        ...
        <div className="absolute inset-0 flex">
           ...
           {/* Left Half (Gustavo) */}
           <div 
             className="w-1/2 h-full cursor-pointer transition-colors duration-300 hover:bg-bocha-pink/60 flex items-end justify-center pb-8 group relative"
             onClick={() => setActiveBio(prev => prev === 'gustavo' ? null : 'gustavo')}
           >
              <span className="text-white font-logo text-3xl uppercase tracking-widest opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 drop-shadow-md">
                Gustavo
              </span>
           </div>
           ...
           <div 
             className="w-1/2 h-full cursor-pointer transition-colors duration-300 hover:bg-bocha-pink/60 flex items-end justify-center pb-8 group relative"
             onClick={() => setActiveBio(prev => prev === 'alvaro' ? null : 'alvaro')}
           >
              <span className="text-white font-logo text-3xl uppercase tracking-widest opacity-0 group-hover:opacity-100 transform translate-y-4 group-hover:translate-y-0 transition-all duration-300 drop-shadow-md">
                Álvaro
              </span>
      ...
      {/* Bio Containers */}
      <div className="w-full max-w-4xl mt-12 min-h-[300px] transition-all duration-500">
        ...
        {/* Hint text when no bio is selected */}
        {!activeBio && (
          <div className="text-center mt-12 opacity-40 animate-pulse">
            <p className="text-sm font-mono uppercase tracking-widest">Tap on a founder to reveal bio</p>
          </div>
        )}
