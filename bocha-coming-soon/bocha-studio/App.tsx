        ...
        <footer className="py-16 border-t border-white/5 bg-black relative z-10">
          <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-gray-500 text-sm">
            ...
            <div className="flex gap-8">
              <a href="#" className="hover:text-bocha-cyan transition-colors font-bold uppercase tracking-wider text-xs">Instagram</a>
              <a href="#" className="hover:text-bocha-pink transition-colors font-bold uppercase tracking-wider text-xs">Twitter</a>
              <a href="#" className="hover:text-bocha-yellow transition-colors font-bold uppercase tracking-wider text-xs">LinkedIn</a>
            </div>
          </div>
        </footer>
      </div>
