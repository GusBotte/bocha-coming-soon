...
export const projects: Project[] = [
  // HOT SALE MX
  {
    ...
    date: '2024.05.20',
    shortDescription: { en: "Sale o no sale", es: "Sale o no sale" },
    fullDescription: {
  ...
  // QUINI 6
  {
    ...
    date: '2024.05.20',
    shortDescription: { en: "La fantasía entra en juego.", es: "La fantasía entra en juego." },
    fullDescription: {
  ...
  // MANI KING
  {
    ...
    date: '2024.06.01',
    shortDescription: { en: "Todo es mejor cuando sos natural", es: "Todo es mejor cuando sos natural" },
    fullDescription: {
  ...
  // PUMA ENERGY
  {
    ...
    date: '2024.06.01',
    shortDescription: { en: "1 promo, 4 mercados y un workflow que optimice la energía de producción.", es: "1 promo, 4 mercados y un workflow que optimice la energía de producción." },
    fullDescription: {
  ...
  // KFC
  {
    ...
    date: '2024.06.01',
    shortDescription: { en: "Todo es mejor con salsa.", es: "Todo es mejor con salsa." },
    fullDescription: {
  ...
  // DIAGNÓSTICO MAIPÚ
  {
    ...
    date: '2024.05.20',
    shortDescription: { en: "Lifescan: Ver hoy lo que importa mañana.", es: "Lifescan: Ver hoy lo que importa mañana." },
    fullDescription: {
  ...
  // BANCO NACIÓN / MASTERCARD
  {
    ...
    date: '2024.06.01',
    shortDescription: { en: "El banco que banca la pasión de los argentinos", es: "El banco que banca la pasión de los argentinos" },
    fullDescription: {
  ...
  // COMPENSATIONLY
  {
    ...
    date: '2024.05.20',
    shortDescription: { en: "Basado en una historia real.", es: "Basado en una historia real." },
    fullDescription: {
