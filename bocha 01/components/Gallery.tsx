            ...
            >
              ...
              <div className="aspect-[4/5] md:aspect-[4/3] overflow-hidden relative z-0">
                ...
                <div className="absolute bottom-0 left-0 w-full p-6 md:p-8 z-10">
                   <h3 className="font-logo text-3xl md:text-4xl mb-1 text-white group-hover:text-bocha-pink transition-colors drop-shadow-md uppercase tracking-wide">
                      {getLocalizedContent(project.title)}
                   </h3>
                   <p className="text-gray-300 text-sm md:text-base line-clamp-2 mb-3 opacity-90">
                      {getLocalizedContent(project.shortDescription || project.description)}
                   </p>
                </div>
              </div>
